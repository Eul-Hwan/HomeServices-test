...
-- 테이블 데이터 hs.migrations:~9 rows (대략적) 내보내기
...
INSERT INTO `services` (`id`, `name`, `slug`, `tagline`, `service_category_id`, `price`, `discount`, `discount_type`, `image`, `thumbnail`, `description`, `inclusion`, `exclusion`, `status`, `created_at`, `updated_at`) VALUES
	...
	(9, 'ratione est aut et', 'ratione-est-aut-et', 'Qui doloribus qui.', 8, 180.00, NULL, NULL, 'service_6.jpg', 'service_6.jpg', 'Cupiditate dolor dolores sunt impedit. Consectetur et id quas labore consequuntur ipsum beatae sed. Accusamus quisquam qui impedit eum. Nostrum quo exercitationem consectetur eius magni dolores. Sunt aut ex et non inventore officiis itaque distinctio. Eligendi tenetur voluptate in qui. Beatae hic sit pariatur veniam tenetur qui. Voluptatem eligendi aut sequi porro quod unde nulla.', 'Dolores alias quae.|Eos et sint.|Repellat deserunt.|Non quis animi sed.|Quo quasi eos velit.', 'Ut provident.|Id nulla non.|Quaerat laboriosam.|Dolorum rem beatae.|Earum debitis neque.', 1, '2021-10-15 10:09:31', '2021-10-15 10:09:31'),
...
-- 테이블 데이터 hs.sessions:~3 rows (대략적) 내보내기
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	...
	('MRMKBHr0AIu2fmrHXmu5ld7ACXZ42sqhbQEXJH3I', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36', '', 1635119721),
