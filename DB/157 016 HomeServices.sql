...
INSERT INTO `services` (`id`, `name`, `slug`, `tagline`, `service_category_id`, `price`, `discount`, `discount_type`, `image`, `thumbnail`, `description`, `inclusion`, `exclusion`, `status`, `created_at`, `updated_at`) VALUES
	...
	(21, 'New Test Service', 'new-test-service', 'Tagline for new service', 12, 120.00, NULL, NULL, '1635036387.jpg', '1635036387.jpg', 'Description here', 'first inclusion|second inclusion|third inclusion', 'first exclusion|second exclusion|third exclusion', 1, '2021-10-24 00:46:27', '2021-10-24 00:46:27');
...
-- 테이블 데이터 hs.sessions:~2 rows (대략적) 내보내기
