...
-- 테이블 데이터 hs.services:~21 rows (대략적) 내보내기
...
INSERT INTO `services` (`id`, `name`, `slug`, `tagline`, `service_category_id`, `price`, `discount`, `discount_type`, `image`, `thumbnail`, `description`, `inclusion`, `exclusion`, `status`, `created_at`, `updated_at`) VALUES
	...
	(5, 'atque reprehenderit vitae expedita', 'atque-reprehenderit-vitae-expedita', 'Ratione quaerat aut.', 17, 486.00, NULL, NULL, 'service_11.jpg', 'service_11.jpg', 'Perferendis sed consequatur aut corporis libero hic id. Asperiores aut similique ea qui. Omnis recusandae commodi occaecati. Debitis quidem delectus dolores omnis perferendis impedit qui. Voluptatem harum eaque ut quisquam reprehenderit. Voluptatem qui recusandae necessitatibus debitis perferendis rem. Ipsam ea deleniti quam tempora. Eos soluta dolore est et aut totam ea. Dolor illum earum voluptate repellendus voluptatem minus. Ut ex quo pariatur fuga excepturi.', 'Fugit officia.|Nobis tempora.|Aliquid aut sunt.|Dolores sunt.|Nihil nihil sint.', 'Voluptate vel eos.|Eligendi non enim.|Officia unde iure.|Corrupti asperiores.|Repellat incidunt.', 1, '2021-10-15 10:09:31', '2021-10-15 10:09:31'),
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('ot5XlV1w15J01vcRTXWbYXUhuDF5r5ObbtYtDg0W', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36', '', 1635036415);
