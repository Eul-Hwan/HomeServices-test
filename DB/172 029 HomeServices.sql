...
-- 테이블 데이터 hs.contacts:~2 rows (대략적) 내보내기
DELETE FROM `contacts`;
/*!40000 ALTER TABLE `contacts` DISABLE KEYS */;
INSERT INTO `contacts` (`id`, `name`, `email`, `phone`, `message`, `created_at`, `updated_at`) VALUES
	(1, '아이유', 'IU@IU.com', '01053788798', 'Test message', '2021-10-29 06:15:36', '2021-10-29 06:15:36'),
	(2, '김고은', 'KimKoEun@Kim.com', '01053788798', 'Another Test Message', '2021-10-29 06:44:15', '2021-10-29 06:44:15');
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(14, '2021_10_29_052343_create_contacts_table', 9);
...
-- 테이블 데이터 hs.service_providers:~2 rows (대략적) 내보내기
...
INSERT INTO `service_providers` (`id`, `user_id`, `image`, `about`, `city`, `service_category_id`, `service_locations`, `created_at`, `updated_at`) VALUES
	(1, 6, '1635470979.jpg', 'Add some text about me.', 'SungNam', NULL, '121001,121002,121003', '2021-10-28 10:54:12', '2021-10-29 01:29:39'),
	(2, 7, '1635638331.jpg', 'About text here.', 'SungNam', 6, '121001,121002,121003', '2021-10-30 23:56:26', '2021-10-30 23:58:51');
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('ufWJUMuHh9BexT7FVSu4eA7VV4KcKhA1fkF4uW0S', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36', '', 1635638365);
...
-- 테이블 데이터 hs.users:~6 rows (대략적) 내보내기
DELETE FROM `users`;
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `remember_token`, `current_team_id`, `profile_photo_path`, `utype`, `created_at`, `updated_at`, `phone`) VALUES
	...
	(7, '김사랑', 'KimLove@Kim.com', NULL, '$2y$10$bU8ITOt3NTsu4shcCPCr7.9d8r6hjAJUOzm1fzvog0qZB70hDLYQG', NULL, NULL, NULL, NULL, NULL, 'SVP', '2021-10-30 23:56:26', '2021-10-30 23:56:26', '0123456789');
