...
-- 테이블 데이터 hs.migrations:~7 rows (대략적) 내보내기
...
-- 테이블 데이터 hs.sessions:~7 rows (대략적) 내보내기
DELETE FROM `sessions`;
/*!40000 ALTER TABLE `sessions` DISABLE KEYS */;
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('0wDXeAMWeaKrlOtr3ps5SMgzJbDci0UlAJySptgX', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36', '', 1634128156),
