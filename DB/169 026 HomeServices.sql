...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(13, '2021_10_28_085537_create_service_providers_table', 8);
...
-- 테이블 hs.service_providers 구조 내보내기
CREATE TABLE IF NOT EXISTS `service_providers` (
  ...
  KEY `service_providers_service_category_id_foreign` (`service_category_id`),
...
-- 테이블 데이터 hs.service_providers:~0 rows (대략적) 내보내기
...
INSERT INTO `service_providers` (`id`, `user_id`, `image`, `about`, `city`, `service_category_id`, `service_locations`, `created_at`, `updated_at`) VALUES
	(1, 6, NULL, NULL, NULL, NULL, NULL, '2021-10-28 10:54:12', '2021-10-28 10:54:12');
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('LzTaVTDOAIjP2fwkgHa9k6lFKmuC89qTNZrRHeI1', 6, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36', '', 1635418690),
	('qmcqaNd1lLOB73ttES9p7r5OfxWP8h2AxkMe9Hpv', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiV2VhMVFjbFNMcDMxT1YzVnVJQ0ZuZkJhSjVHOTVCYXY4UEZjbFlBViI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1635411267),
	('tyH9UXwGC2ZQT6JAvmCSVEaaQnpGTKUvOOf6bKgq', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36', '', 1635400997);
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `remember_token`, `current_team_id`, `profile_photo_path`, `utype`, `created_at`, `updated_at`, `phone`) VALUES
	...
	(6, 'Test', 'test@test.com', NULL, '$2y$10$b22a.mQ3t8L9HTO67KRkReoaKdj6K6GmcYeF7vpYtgyYHgNghe1C6', NULL, NULL, NULL, NULL, NULL, 'SVP', '2021-10-28 10:54:12', '2021-10-28 10:54:12', '0105378879');
